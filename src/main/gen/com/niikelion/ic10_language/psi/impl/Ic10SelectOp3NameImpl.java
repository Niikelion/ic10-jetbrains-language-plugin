...
public class Ic10SelectOp3NameImpl extends ASTWrapperPsiElement implements Ic10SelectOp3Name {

  public Ic10SelectOp3NameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitSelectOp3Name(this);
  }
