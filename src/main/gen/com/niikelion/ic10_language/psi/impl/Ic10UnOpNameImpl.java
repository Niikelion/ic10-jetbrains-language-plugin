...
public class Ic10UnOpNameImpl extends ASTWrapperPsiElement implements Ic10UnOpName {

  public Ic10UnOpNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitUnOpName(this);
  }
