...
public class Ic10BranchOp3NameImpl extends ASTWrapperPsiElement implements Ic10BranchOp3Name {

  public Ic10BranchOp3NameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitBranchOp3Name(this);
  }
