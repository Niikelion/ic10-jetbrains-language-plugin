...
public class Ic10BranchOpDevNameImpl extends ASTWrapperPsiElement implements Ic10BranchOpDevName {

  public Ic10BranchOpDevNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitBranchOpDevName(this);
  }
