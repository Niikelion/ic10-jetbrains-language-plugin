...
public class Ic10BinOpNameImpl extends ASTWrapperPsiElement implements Ic10BinOpName {

  public Ic10BinOpNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitBinOpName(this);
  }
