...
public class Ic10BranchOp1NameImpl extends ASTWrapperPsiElement implements Ic10BranchOp1Name {

  public Ic10BranchOp1NameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitBranchOp1Name(this);
  }
