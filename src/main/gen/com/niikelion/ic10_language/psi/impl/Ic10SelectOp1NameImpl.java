...
public class Ic10SelectOp1NameImpl extends ASTWrapperPsiElement implements Ic10SelectOp1Name {

  public Ic10SelectOp1NameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitSelectOp1Name(this);
  }
