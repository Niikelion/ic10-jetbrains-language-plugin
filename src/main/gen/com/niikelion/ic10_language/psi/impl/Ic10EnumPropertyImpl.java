...
public class Ic10EnumPropertyImpl extends ASTWrapperPsiElement implements Ic10EnumProperty {

  public Ic10EnumPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitEnumProperty(this);
  }
