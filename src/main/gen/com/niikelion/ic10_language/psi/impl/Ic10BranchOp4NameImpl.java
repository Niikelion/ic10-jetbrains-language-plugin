...
public class Ic10BranchOp4NameImpl extends ASTWrapperPsiElement implements Ic10BranchOp4Name {

  public Ic10BranchOp4NameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitBranchOp4Name(this);
  }
