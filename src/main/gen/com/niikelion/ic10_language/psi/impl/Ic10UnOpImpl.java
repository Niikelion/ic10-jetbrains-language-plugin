...
public class Ic10UnOpImpl extends ASTWrapperPsiElement implements Ic10UnOp {

  public Ic10UnOpImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Ic10UnOpName getUnOpName() {
    return findNotNullChildByClass(Ic10UnOpName.class);
  }
