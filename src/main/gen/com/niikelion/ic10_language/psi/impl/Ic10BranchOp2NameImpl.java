...
public class Ic10BranchOp2NameImpl extends ASTWrapperPsiElement implements Ic10BranchOp2Name {

  public Ic10BranchOp2NameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Ic10Visitor visitor) {
    visitor.visitBranchOp2Name(this);
  }
